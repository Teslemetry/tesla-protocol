...
class SeiMetadata(_message.Message):
    ...
    def __init__(self, field_1: _Optional[int]=..., gearState: _Optional[_Union[SeiMetadata.Gear, str]]=..., frameSeqNo: _Optional[int]=..., vehicleSpeedMps: _Optional[float]=..., acceleratorPedalPosition: _Optional[float]=..., steeringWheelAngle: _Optional[float]=..., blinkerOnLeft: _Optional[bool]=..., blinkerOnRight: _Optional[bool]=..., brakeApplied: _Optional[bool]=..., autopilotState: _Optional[_Union[SeiMetadata.AutopilotState, str]]=..., latitudeDeg: _Optional[float]=..., longitudeDeg: _Optional[float]=..., headingDeg: _Optional[float]=..., linearAccelerationMps2X: _Optional[float]=..., linearAccelerationMps2Y: _Optional[float]=..., linearAccelerationMps2Z: _Optional[float]=...) -> None:
        ...