...
class ClosuresState(_message.Message):
    ...
    CRUISE_SPEED_LIMIT_MPH_FIELD_NUMBER: _ClassVar[int]
...
class ParentalControlsSettings(_message.Message):
    ...
    def __init__(self, speed_limit_enabled: bool=..., max_limit_mph: _Optional[float]=..., min_limit_mph: _Optional[float]=..., current_limit_mph: _Optional[float]=..., chill_acceleration_enabled: bool=..., require_safety_settings_enabled: bool=..., curfew_enabled: bool=..., curfew_start_time: _Optional[int]=..., curfew_end_time: _Optional[int]=..., browser_blocked: bool=..., theater_blocked: bool=..., arcade_blocked: bool=...) -> None:
        ...
...
class DriveState(_message.Message):
    ...
    class FsdLast7DaysUsage(_message.Message):
        ...
        def __init__(self, week_starts_on_sunday: bool=..., day_usage: _Optional[_Iterable[bool]]=...) -> None:
            ...
...
class ChargeState(_message.Message):
    ...
    class PowershareType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        PowershareTypePowerwall: _ClassVar[ChargeState.PowershareType]
...
class VehicleState(_message.Message):
    ...
    def __init__(self, software_update_state: _Optional[_Union[SoftwareUpdateState, _Mapping]]=..., legacy_media_state: _Optional[_Union[LegacyMediaState, _Mapping]]=..., timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., feature_bitmask: _Optional[_Iterable[int]]=..., tpms_last_seen_pressure_time_fl: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_last_seen_pressure_time_fr: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_last_seen_pressure_time_rl: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_last_seen_pressure_time_rr: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., deck_lights_on: bool=..., hazards_on: bool=..., deck_lights_allowed: bool=..., legacy_media_info: _Optional[_Union[LegacyMediaInfo, _Mapping]]=..., allow_authorized_mobile_devices_only: bool=..., guestMode: _Optional[_Union[VehicleState.GuestMode, _Mapping]]=..., drive_rail_on: bool=..., pin_to_drive_enabled: bool=..., pin_to_drive_pin_set: bool=..., frontfoglights_on: bool=..., rearfoglights_on: bool=..., headlights_on: bool=..., highbeamlights_on: bool=..., trailer_mode_on: bool=..., trailer_light_test_available: bool=..., trailer_light_test_requested: bool=..., truck_bed_lights_brightness: _Optional[int]=..., signed_cmd_service_mode: bool=..., accessory_lightbar_middle_on: bool=..., transport_mode: bool=..., truck_bed_lights_auto_brightness: _Optional[int]=..., truck_bed_lights_auto_state: bool=..., truck_bed_lights_controls_disabled: bool=..., service_mode_auth: _Optional[str]=..., service_gtw_diag_session_active: bool=..., factory_mode: bool=..., training_wheels_mode: bool=..., gtw_diag_level: _Optional[_Union[_common_pb2.GtwDiagLevel, str]]=..., parental_controls_active: bool=..., parental_controls_pin_set: bool=..., parental_controls_settings: _Optional[_Union[ParentalControlsSettings, _Mapping]]=..., api_version: _Optional[int]=..., car_version: _Optional[str]=..., detailed_version: _Optional[str]=..., autopilot_hash: _Optional[str]=..., vehicle_name: _Optional[str]=..., notifications_supported: bool=..., remote_start_supported: bool=..., remote_start_enabled: bool=..., last_autopark_error: _Optional[str]=..., homelink_device_count: _Optional[int]=..., smart_summon_available: bool=..., summon_standby_mode_enabled: bool=..., patsy_mode: bool=..., webcam_available: bool=..., vehicle_self_test_requested: bool=..., vehicle_self_test_progress: _Optional[int]=..., calendar_supported: bool=..., dashcam_clip_save_available: bool=..., dashcam_state: _Optional[_Union[DashCamState, str]]=..., tpms_pressure_fl: _Optional[float]=..., tpms_pressure_fr: _Optional[float]=..., tpms_pressure_rl: _Optional[float]=..., tpms_pressure_rr: _Optional[float]=..., service_mode: bool=..., service_mode_plus: bool=..., tpms_hard_warning_fl: bool=..., tpms_hard_warning_fr: bool=..., tpms_hard_warning_rl: bool=..., tpms_hard_warning_rr: bool=..., tpms_soft_warning_fl: bool=..., tpms_soft_warning_fr: bool=..., tpms_soft_warning_rl: bool=..., tpms_soft_warning_rr: bool=..., tpms_rcp_front_value: _Optional[float]=..., tpms_rcp_rear_value: _Optional[float]=..., fsd_software_version: _Optional[str]=..., autopilot_base: _Optional[_Union[AutopilotBase, str]]=..., autopilot_override_state: _Optional[_Union[AutopilotOverrideState, str]]=..., autopilot_override_expire_time: _Optional[int]=...) -> None:
        ...
...
class LegacyMediaState(_message.Message):
    ...
    def __init__(self, remote_control_enabled: bool=...) -> None:
        ...
...
class TirePressureState(_message.Message):
    ...
    def __init__(self, timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_pressure_fl: _Optional[float]=..., tpms_pressure_fr: _Optional[float]=..., tpms_pressure_rl: _Optional[float]=..., tpms_pressure_rr: _Optional[float]=..., tpms_last_seen_pressure_time_fl: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_last_seen_pressure_time_fr: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_last_seen_pressure_time_rl: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_last_seen_pressure_time_rr: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_hard_warning_fl: bool=..., tpms_hard_warning_fr: bool=..., tpms_hard_warning_rl: bool=..., tpms_hard_warning_rr: bool=..., tpms_soft_warning_fl: bool=..., tpms_soft_warning_fr: bool=..., tpms_soft_warning_rl: bool=..., tpms_soft_warning_rr: bool=..., tpms_rcp_front_value: _Optional[float]=..., tpms_rcp_rear_value: _Optional[float]=..., tpms_pressure_re1_l0: _Optional[float]=..., tpms_pressure_re1_l1: _Optional[float]=..., tpms_pressure_re1_r0: _Optional[float]=..., tpms_pressure_re1_r1: _Optional[float]=..., tpms_pressure_re2_l0: _Optional[float]=..., tpms_pressure_re2_l1: _Optional[float]=..., tpms_pressure_re2_r0: _Optional[float]=..., tpms_pressure_re2_r1: _Optional[float]=..., tpms_last_seen_pressure_time_re1_l0: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_last_seen_pressure_time_re1_l1: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_last_seen_pressure_time_re1_r0: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_last_seen_pressure_time_re1_r1: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_last_seen_pressure_time_re2_l0: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_last_seen_pressure_time_re2_l1: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_last_seen_pressure_time_re2_r0: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_last_seen_pressure_time_re2_r1: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., tpms_hard_warning_re1_l0: bool=..., tpms_hard_warning_re1_l1: bool=..., tpms_hard_warning_re1_r0: bool=..., tpms_hard_warning_re1_r1: bool=..., tpms_hard_warning_re2_l0: bool=..., tpms_hard_warning_re2_l1: bool=..., tpms_hard_warning_re2_r0: bool=..., tpms_hard_warning_re2_r1: bool=..., tpms_soft_warning_re1_l0: bool=..., tpms_soft_warning_re1_l1: bool=..., tpms_soft_warning_re1_r0: bool=..., tpms_soft_warning_re1_r1: bool=..., tpms_soft_warning_re2_l0: bool=..., tpms_soft_warning_re2_l1: bool=..., tpms_soft_warning_re2_r0: bool=..., tpms_soft_warning_re2_r1: bool=..., tpms_temperature_fl: _Optional[float]=..., tpms_temperature_fr: _Optional[float]=..., tpms_temperature_rl: _Optional[float]=..., tpms_temperature_rr: _Optional[float]=..., tpms_temperature_re1_l0: _Optional[float]=..., tpms_temperature_re1_l1: _Optional[float]=..., tpms_temperature_re1_r0: _Optional[float]=..., tpms_temperature_re1_r1: _Optional[float]=..., tpms_temperature_re2_l0: _Optional[float]=..., tpms_temperature_re2_l1: _Optional[float]=..., tpms_temperature_re2_r0: _Optional[float]=..., tpms_temperature_re2_r1: _Optional[float]=..., tpms_temperature_hard_warning_fl: bool=..., tpms_temperature_hard_warning_fr: bool=..., tpms_temperature_hard_warning_rl: bool=..., tpms_temperature_hard_warning_rr: bool=..., tpms_temperature_hard_warning_re1_l0: bool=..., tpms_temperature_hard_warning_re1_l1: bool=..., tpms_temperature_hard_warning_re1_r0: bool=..., tpms_temperature_hard_warning_re1_r1: bool=..., tpms_temperature_hard_warning_re2_l0: bool=..., tpms_temperature_hard_warning_re2_l1: bool=..., tpms_temperature_hard_warning_re2_r0: bool=..., tpms_temperature_hard_warning_re2_r1: bool=..., tpms_temperature_soft_warning_fl: bool=..., tpms_temperature_soft_warning_fr: bool=..., tpms_temperature_soft_warning_rl: bool=..., tpms_temperature_soft_warning_rr: bool=..., tpms_temperature_soft_warning_re1_l0: bool=..., tpms_temperature_soft_warning_re1_l1: bool=..., tpms_temperature_soft_warning_re1_r0: bool=..., tpms_temperature_soft_warning_re1_r1: bool=..., tpms_temperature_soft_warning_re2_l0: bool=..., tpms_temperature_soft_warning_re2_l1: bool=..., tpms_temperature_soft_warning_re2_r0: bool=..., tpms_temperature_soft_warning_re2_r1: bool=...) -> None:
        ...
...
class GuiSettings(_message.Message):
    ...
    def __init__(self, timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., gui_24_hour_time: bool=..., show_range_units: bool=..., gui_tirepressure_units: _Optional[_Union[GuiSettings.TirePressureUnit, str]]=...) -> None:
        ...
...
class VehicleConfig(_message.Message):
    ...
    def __init__(self, interior_trim_type: _Optional[_Union[VehicleConfig.InteriorTrimType, _Mapping]]=..., exterior_trim_type: _Optional[_Union[VehicleConfig.ExteriorTrimType, _Mapping]]=..., red_brake_calipers: bool=..., use_range_badging: bool=..., range_plus_badging: bool=..., has_ludicrous_mode: bool=..., can_actuate_trunks: bool=..., has_air_suspension: bool=..., ece_restrictions: bool=..., eu_vehicle: bool=..., motorized_charge_port: bool=..., can_accept_navigation_requests: bool=..., key_version: _Optional[int]=..., mobile_enabled: bool=..., default_charge_to_max: bool=..., steering_wheel_heater_installed: bool=..., sentry_mode_supported: bool=..., homelink_supported: bool=..., webcam_supported: bool=..., bioweapon_mode_supported: bool=..., dashcam_clip_save_supported: bool=..., has_pws: bool=..., utc_offset: _Optional[int]=..., has_seat_cooling: bool=..., paint_color_override: _Optional[str]=..., tpms_pressures_supported: bool=..., vehicle_badging: _Optional[int]=..., exterior_trim_override: _Optional[str]=..., headlamp_type: _Optional[_Union[VehicleConfig.HeadlampType_E, str]]=..., aux_park_lamps: _Optional[_Union[VehicleConfig.AuxParkLamps_E, str]]=..., is_raven: bool=..., has_auto_seat_climate: bool=..., has_front_row_seat_heaters: bool=..., has_third_row_seat_heaters: bool=..., supports_qr_pairing: bool=..., disable_window_vent_close: bool=..., webcam_selfie_supported: bool=..., cop_user_set_temp_supported: bool=..., has_auto_stw_heat: bool=..., rearlight_type: _Optional[_Union[VehicleConfig.RearLightType, str]]=..., rear_seat_heater_type: _Optional[_Union[_common_pb2.RearSeatHeaterType, str]]=..., webcam_grid_supported: bool=..., has_tesla_badge: bool=..., has_tesla_wordmark: bool=..., fascia_type: _Optional[_Union[_common_pb2.FasciaType, str]]=..., accessory_lightbar_type: _Optional[_Union[_common_pb2.AccessoryLightbarType, str]]=..., sentry_preview_supported: bool=..., seat_trim_type: _Optional[_Union[VehicleConfig.SeatTrimType, str]]=..., drivetrain_type: _Optional[_Union[VehicleConfig.DrivetrainType, str]]=..., lightshow_supported: bool=..., mobile_dashcam_viewer_version: _Optional[int]=..., has_premium_connectivity: bool=..., car_wrap_enabled: bool=..., supports_ride_height: bool=..., supports_set_arrival_energy: bool=..., supports_pillar_camera_metadata: bool=..., chassis_type: _Optional[_Union[_common_pb2.ChassisType, str]]=..., is_china_vehicle: bool=..., is_using_unreal_apviz: bool=..., supports_flexible_dashcam_bitrate: bool=..., front_fascia_camera_type: _Optional[_Union[VehicleConfig.FrontFasciaCameraType, str]]=..., turn_indicator_control_type: _Optional[_Union[VehicleConfig.TurnIndicatorControlType, str]]=..., has_rear_display: bool=..., window_tint_color: _Optional[str]=..., interior_upper_trim_type: _Optional[_Union[VehicleConfig.InteriorUpperTrimType, str]]=..., badging_material_type: _Optional[_Union[VehicleConfig.BadgingMaterialType, str]]=..., webcam_interior_only: bool=..., country_code: _Optional[str]=..., bed_lighting_type: _Optional[_Union[VehicleConfig.BedLightingType, str]]=..., rear_light_hardware_variant: _Optional[_Union[VehicleConfig.RearLightHardwareVariant, str]]=..., autopilot_base: _Optional[_Union[AutopilotBase, str]]=..., autopilot_override_state: _Optional[_Union[AutopilotOverrideState, str]]=..., autopilot_override_expire_time: _Optional[int]=..., supports_dynamic_environments: bool=...) -> None:
        ...
...
class ParkedAccessoryState(_message.Message):
    ...
    def __init__(self, tent_mode_request: bool=..., horizon_leveling_state: bool=..., front_zone_light_request: _Optional[_Union[_common_pb2.ZoneLightRequest, str]]=..., rear_zone_light_request: _Optional[_Union[_common_pb2.ZoneLightRequest, str]]=..., truck_bed_lights_brightness: _Optional[int]=..., truck_bed_lights_auto_brightness: _Optional[int]=..., truck_bed_lights_auto_state: bool=..., truck_bed_lights_controls_disabled: bool=..., accessory_lightbar_middle_on: bool=..., accessory_lightbar_ditch_on: bool=..., accessory_lightbar_brightness: _Optional[int]=..., accessory_lightbar_low: _Optional[int]=..., accessory_lightbar_med: _Optional[int]=..., accessory_lightbar_high: _Optional[int]=..., has_tent_mode: bool=..., timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
...
class LightShowState(_message.Message):
    ...
    def __init__(self, timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., light_show_active: bool=..., light_show_selected_name: _Optional[str]=..., light_show_start_time: _Optional[int]=..., light_show_settings: _Optional[_Union[LightShowSettings, _Mapping]]=...) -> None:
        ...
...
class ChildPresenceDetectionState(_message.Message):
    ...
    def __init__(self, cpd_disable_notification_required: bool=..., cpd_hvac_active: bool=..., cpd_supports_critical_alerts: bool=..., timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
...
class DisplayState(_message.Message):
    ...
    def __init__(self, displayBrightnessAuto: bool=..., displayBrightnessScalePreference: _Optional[int]=..., timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=...) -> None:
        ...
...
class VehicleDetailState(_message.Message):
    ...
    IS_FSD_V14_OR_ABOVE_FIELD_NUMBER: _ClassVar[int]
    timestamp: _timestamp_pb2.Timestamp
    vehicle_name: str
    car_version: str
    detailed_version: str
    ...
    def __init__(self, timestamp: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]]=..., vehicle_name: _Optional[str]=..., car_version: _Optional[str]=..., detailed_version: _Optional[str]=..., autopilot_hash: _Optional[str]=..., fsd_software_version: _Optional[str]=..., current_profile_name: _Optional[str]=..., china_autopilot_software_version: _Optional[str]=..., is_fsd_v14_or_above: bool=...) -> None:
        ...