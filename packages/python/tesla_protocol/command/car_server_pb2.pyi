...
class VehicleAction(_message.Message):
    ...
    SETUPKEEPUSERNAMEACTION_FIELD_NUMBER: _ClassVar[int]
    ...
    PREPAREMOBILEUPLOADACTION_FIELD_NUMBER: _ClassVar[int]
    PUTMOBILEUPLOADCHUNKACTION_FIELD_NUMBER: _ClassVar[int]
    DISPLAYSTATEACTION_FIELD_NUMBER: _ClassVar[int]
    DRIVINGSETCRUISESPEEDLIMITACTION_FIELD_NUMBER: _ClassVar[int]
    SETDECKLIGHTACTION_FIELD_NUMBER: _ClassVar[int]
    ...
    setUpkeepUsernameAction: SetUpkeepUsernameAction
    ...
    prepareMobileUploadAction: PrepareMobileUploadAction
    putMobileUploadChunkAction: PutMobileUploadChunkAction
...
class DogModeLiveActivityData(_message.Message):
    ...
    interiorImage: DogModeLiveActivityData.DogModeImageData
    field_3: str
    field_4: _timestamp_pb2.Timestamp
...
class NavigationSuperchargerRequest(_message.Message):
    ...
    class RemoteNavTripOrder(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        REMOTE_NAV_TRIP_ORDER_REPLACE: _ClassVar[NavigationSuperchargerRequest.RemoteNavTripOrder]
        REMOTE_NAV_TRIP_ORDER_PREPEND: _ClassVar[NavigationSuperchargerRequest.RemoteNavTripOrder]
        REMOTE_NAV_TRIP_ORDER_APPEND: _ClassVar[NavigationSuperchargerRequest.RemoteNavTripOrder]
    REMOTE_NAV_TRIP_ORDER_UNKNOWN: NavigationSuperchargerRequest.RemoteNavTripOrder
...
class ParentalControlsEnableSettingsAction(_message.Message):
    ...
    class ParentalControlsSetting_E(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        ...
        Acceleration: _ClassVar[ParentalControlsEnableSettingsAction.ParentalControlsSetting_E]
        SafetyFeatures: _ClassVar[ParentalControlsEnableSettingsAction.ParentalControlsSetting_E]
        Curfew: _ClassVar[ParentalControlsEnableSettingsAction.ParentalControlsSetting_E]
        BrowserBlocked: _ClassVar[ParentalControlsEnableSettingsAction.ParentalControlsSetting_E]
        TheaterBlocked: _ClassVar[ParentalControlsEnableSettingsAction.ParentalControlsSetting_E]
        ArcadeBlocked: _ClassVar[ParentalControlsEnableSettingsAction.ParentalControlsSetting_E]
    SpeedLimit: ParentalControlsEnableSettingsAction.ParentalControlsSetting_E
    Acceleration: ParentalControlsEnableSettingsAction.ParentalControlsSetting_E
    SafetyFeatures: ParentalControlsEnableSettingsAction.ParentalControlsSetting_E
    Curfew: ParentalControlsEnableSettingsAction.ParentalControlsSetting_E
    BrowserBlocked: ParentalControlsEnableSettingsAction.ParentalControlsSetting_E
    TheaterBlocked: ParentalControlsEnableSettingsAction.ParentalControlsSetting_E
    ArcadeBlocked: ParentalControlsEnableSettingsAction.ParentalControlsSetting_E
