 ...
 * UPSTREAM-PATH:   pkg/protocol/protobuf/universal_message.proto
...
export enum Domain {
  ...
  /** DOMAIN_AUTOPILOT - TESLEMETRY-EXT */
  DOMAIN_AUTOPILOT = 4,
  /** DOMAIN_AUTHD - TESLEMETRY-EXT */
  DOMAIN_AUTHD = 5,
  /** DOMAIN_ENERGY_DEVICE - TESLEMETRY-EXT */
  DOMAIN_ENERGY_DEVICE = 7,
  /** DOMAIN_ENERGY_DEVICE_AUTH - TESLEMETRY-EXT */
...
export enum MessageFaultE {
  ...
  /** MESSAGEFAULT_ERROR_REQUEST_MTU_EXCEEDED - Client sent a request with a field that exceeds MTU */
  MESSAGEFAULT_ERROR_REQUEST_MTU_EXCEEDED = 24,
  /** MESSAGEFAULT_ERROR_RESPONSE_MTU_EXCEEDED - Client's request was received, but response size exceeded MTU */
...
export function messageFaultEFromJSON(object: any): MessageFaultE {
  switch (object) {
    ...
    case 24:
    case "MESSAGEFAULT_ERROR_REQUEST_MTU_EXCEEDED":
      return MessageFaultE.MESSAGEFAULT_ERROR_REQUEST_MTU_EXCEEDED;
    case 25:
    case "MESSAGEFAULT_ERROR_RESPONSE_MTU_EXCEEDED":
      return MessageFaultE.MESSAGEFAULT_ERROR_RESPONSE_MTU_EXCEEDED;
    case 26:
    case "MESSAGEFAULT_ERROR_REPEATED_COUNTER":
      return MessageFaultE.MESSAGEFAULT_ERROR_REPEATED_COUNTER;
    case 27:
    case "MESSAGEFAULT_ERROR_INVALID_KEY_HANDLE":
      return MessageFaultE.MESSAGEFAULT_ERROR_INVALID_KEY_HANDLE;
    case 28:
...
export function messageFaultEToJSON(object: MessageFaultE): string {
  switch (object) {
    ...
    case MessageFaultE.MESSAGEFAULT_ERROR_REQUEST_MTU_EXCEEDED:
      return "MESSAGEFAULT_ERROR_REQUEST_MTU_EXCEEDED";
    case MessageFaultE.MESSAGEFAULT_ERROR_RESPONSE_MTU_EXCEEDED:
      return "MESSAGEFAULT_ERROR_RESPONSE_MTU_EXCEEDED";
    case MessageFaultE.MESSAGEFAULT_ERROR_REPEATED_COUNTER:
      return "MESSAGEFAULT_ERROR_REPEATED_COUNTER";
    case MessageFaultE.MESSAGEFAULT_ERROR_INVALID_KEY_HANDLE:
...
export const MessageStatus: MessageFns<MessageStatus> = {
  ...
  toJSON(message: MessageStatus): unknown {
    ...
    if (message.signedMessageFault !== undefined) {
