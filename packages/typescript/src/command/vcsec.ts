...
export enum KeyFormFactor {
  ...
  /** KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB - TESLEMETRY-EXT */
  KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB = 2,
  /** KEY_FORM_FACTOR_BLE_DEVICE - TESLEMETRY-EXT */
  KEY_FORM_FACTOR_BLE_DEVICE = 3,
  /** KEY_FORM_FACTOR_NFC_DEVICE - TESLEMETRY-EXT */
  KEY_FORM_FACTOR_NFC_DEVICE = 4,
  /** KEY_FORM_FACTOR_BLE_AND_NFC_DEVICE - TESLEMETRY-EXT */
  KEY_FORM_FACTOR_BLE_AND_NFC_DEVICE = 5,
  KEY_FORM_FACTOR_IOS_DEVICE = 6,
  KEY_FORM_FACTOR_ANDROID_DEVICE = 7,
  /** KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB_P60 - TESLEMETRY-EXT */
  KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB_P60 = 8,
  KEY_FORM_FACTOR_CLOUD_KEY = 9,
  /** KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60 - TESLEMETRY-EXT */
  KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60 = 10,
  /** KEY_FORM_FACTOR_5_BUTTON_GEN2_CAR_KEYFOB_P60 - TESLEMETRY-EXT */
  KEY_FORM_FACTOR_5_BUTTON_GEN2_CAR_KEYFOB_P60 = 11,
  /** KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V2 - TESLEMETRY-EXT */
  KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V2 = 12,
  /** KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V3 - TESLEMETRY-EXT */
  KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V3 = 13,
  /** KEY_FORM_FACTOR_NFC_CARD_P71 - TESLEMETRY-EXT */
  KEY_FORM_FACTOR_NFC_CARD_P71 = 14,
  /** KEY_FORM_FACTOR_NFC_CARD_METAL_CARD - TESLEMETRY-EXT */
  KEY_FORM_FACTOR_NFC_CARD_METAL_CARD = 15,
  /** KEY_FORM_FACTOR_NFC_CARD_PLASTIC_CARD - TESLEMETRY-EXT */
  KEY_FORM_FACTOR_NFC_CARD_PLASTIC_CARD = 16,
  /** KEY_FORM_FACTOR_APPLE_WATCH - TESLEMETRY-EXT */
  KEY_FORM_FACTOR_APPLE_WATCH = 17,
  /** KEY_FORM_FACTOR_NFC_CARD_WD_PLASTIC_CARD - TESLEMETRY-EXT */
  KEY_FORM_FACTOR_NFC_CARD_WD_PLASTIC_CARD = 18,
  /** KEY_FORM_FACTOR_HARMONY_OS_NEXT_DEVICE - TESLEMETRY-EXT */
...
export enum InformationRequestType {
  ...
  /** INFORMATION_REQUEST_TYPE_GET_TOKEN - TESLEMETRY-EXT */
  INFORMATION_REQUEST_TYPE_GET_TOKEN = 1,
  /** INFORMATION_REQUEST_TYPE_GET_COUNTER - TESLEMETRY-EXT */
  INFORMATION_REQUEST_TYPE_GET_COUNTER = 2,
  /** INFORMATION_REQUEST_TYPE_GET_EPHEMERAL_PUBLIC_KEY - TESLEMETRY-EXT */
  INFORMATION_REQUEST_TYPE_GET_EPHEMERAL_PUBLIC_KEY = 3,
  /** INFORMATION_REQUEST_TYPE_GET_SESSION_DATA - TESLEMETRY-EXT */
  ...
  /** INFORMATION_REQUEST_TYPE_GET_PERSONALIZATION_INFO - TESLEMETRY-EXT */
  INFORMATION_REQUEST_TYPE_GET_PERSONALIZATION_INFO = 7,
  /** INFORMATION_REQUEST_TYPE_GET_KEYSTATUS_INFO - TESLEMETRY-EXT */
  INFORMATION_REQUEST_TYPE_GET_KEYSTATUS_INFO = 8,
  /** INFORMATION_REQUEST_TYPE_GET_ACTIVE_KEY - TESLEMETRY-EXT */
  INFORMATION_REQUEST_TYPE_GET_ACTIVE_KEY = 9,
  /** INFORMATION_REQUEST_TYPE_GET_CAPABILITIES - TESLEMETRY-EXT */
...
export enum RKEActionE {
  RKE_ACTION_UNLOCK = 0,
  RKE_ACTION_LOCK = 1,
  /** RKE_ACTION_OPEN_TRUNK - TESLEMETRY-EXT */
  RKE_ACTION_OPEN_TRUNK = 2,
  /** RKE_ACTION_OPEN_FRUNK - TESLEMETRY-EXT */
  RKE_ACTION_OPEN_FRUNK = 3,
  /** RKE_ACTION_OPEN_CHARGE_PORT - TESLEMETRY-EXT */
  RKE_ACTION_OPEN_CHARGE_PORT = 4,
  /** RKE_ACTION_CLOSE_CHARGE_PORT - TESLEMETRY-EXT */
  RKE_ACTION_CLOSE_CHARGE_PORT = 5,
  /** RKE_ACTION_CANCEL_EXTERNAL_AUTHENTICATE - TESLEMETRY-EXT */
  RKE_ACTION_CANCEL_EXTERNAL_AUTHENTICATE = 6,
  /** RKE_ACTION_UNKNOWN - TESLEMETRY-EXT */
...
export function rKEActionEFromJSON(object: any): RKEActionE {
  switch (object) {
    ...
    case 32:
    case "RKE_ACTION_UNLOCK_UNRESTRICTED_CLOSURES":
      return RKEActionE.RKE_ACTION_UNLOCK_UNRESTRICTED_CLOSURES;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function rKEActionEToJSON(object: RKEActionE): string {
  switch (object) {
    ...
    case RKEActionE.RKE_ACTION_UNLOCK_UNRESTRICTED_CLOSURES:
      return "RKE_ACTION_UNLOCK_UNRESTRICTED_CLOSURES";
...
export enum ClosureMoveTypeE {
  ...
  /** CLOSURE_MOVE_TYPE_OVERRIDE_OPEN - TESLEMETRY-EXT */
  CLOSURE_MOVE_TYPE_OVERRIDE_OPEN = 5,
  /** CLOSURE_MOVE_TYPE_OVERRIDE_CLOSE - TESLEMETRY-EXT */
...
export enum WhitelistOperationInformationE {
  ...
  /** WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_RIDER_KEY - TESLEMETRY-EXT */
  WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_RIDER_KEY = 29,
  /** WHITELISTOPERATION_INFORMATION_ATTEMPTING_TO_ADD_RIDER_KEY_OUTSIDE_FLEET_MODE - TESLEMETRY-EXT */
  WHITELISTOPERATION_INFORMATION_ATTEMPTING_TO_ADD_RIDER_KEY_OUTSIDE_FLEET_MODE = 30,
  /** WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_PREDELIVERY_KEY - TESLEMETRY-EXT */
  WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_PREDELIVERY_KEY = 31,
  /** WHITELISTOPERATION_INFORMATION_SERVICE_KEY_ATTEMPTING_TO_ADD_PREDELIVERY_KEY_WHEN_ALREADY_DELIVERED - TESLEMETRY-EXT */
