...
import { NominalError } from "./errors.js";
 ...
 * UPSTREAM-PATH:   pkg/protocol/protobuf/vcsec.proto
...
export enum KeyFormFactor {
  ...
  /** KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB - TESLEMETRY-EXT (app-4.58.6) */
  KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB = 2,
  /** KEY_FORM_FACTOR_BLE_DEVICE - TESLEMETRY-EXT (app-4.58.6) */
  KEY_FORM_FACTOR_BLE_DEVICE = 3,
  /** KEY_FORM_FACTOR_NFC_DEVICE - TESLEMETRY-EXT (app-4.58.6) */
  KEY_FORM_FACTOR_NFC_DEVICE = 4,
  /** KEY_FORM_FACTOR_BLE_AND_NFC_DEVICE - TESLEMETRY-EXT (app-4.58.6) */
  KEY_FORM_FACTOR_BLE_AND_NFC_DEVICE = 5,
  KEY_FORM_FACTOR_IOS_DEVICE = 6,
  KEY_FORM_FACTOR_ANDROID_DEVICE = 7,
  /** KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB_P60 - TESLEMETRY-EXT (app-4.58.6) */
  KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB_P60 = 8,
  KEY_FORM_FACTOR_CLOUD_KEY = 9,
  /** KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60 - TESLEMETRY-EXT (app-4.58.6) */
  KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60 = 10,
  /** KEY_FORM_FACTOR_5_BUTTON_GEN2_CAR_KEYFOB_P60 - TESLEMETRY-EXT (app-4.58.6) */
  KEY_FORM_FACTOR_5_BUTTON_GEN2_CAR_KEYFOB_P60 = 11,
  /** KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V2 - TESLEMETRY-EXT (app-4.58.6) */
  KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V2 = 12,
  /** KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V3 - TESLEMETRY-EXT (app-4.58.6) */
  KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V3 = 13,
  /** KEY_FORM_FACTOR_NFC_CARD_P71 - TESLEMETRY-EXT (app-4.58.6) */
  KEY_FORM_FACTOR_NFC_CARD_P71 = 14,
  /** KEY_FORM_FACTOR_NFC_CARD_METAL_CARD - TESLEMETRY-EXT (app-4.58.6) */
  KEY_FORM_FACTOR_NFC_CARD_METAL_CARD = 15,
  /** KEY_FORM_FACTOR_NFC_CARD_PLASTIC_CARD - TESLEMETRY-EXT (app-4.58.6) */
  KEY_FORM_FACTOR_NFC_CARD_PLASTIC_CARD = 16,
  /** KEY_FORM_FACTOR_APPLE_WATCH - TESLEMETRY-EXT (app-4.58.6) */
  KEY_FORM_FACTOR_APPLE_WATCH = 17,
  /** KEY_FORM_FACTOR_NFC_CARD_WD_PLASTIC_CARD - TESLEMETRY-EXT (app-4.58.6) */
  KEY_FORM_FACTOR_NFC_CARD_WD_PLASTIC_CARD = 18,
  /** KEY_FORM_FACTOR_HARMONY_OS_NEXT_DEVICE - TESLEMETRY-EXT (app-4.58.6) */
...
export function keyFormFactorFromJSON(object: any): KeyFormFactor {
  switch (object) {
    ...
    case 2:
    case "KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB":
      return KeyFormFactor.KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB;
    case 3:
    case "KEY_FORM_FACTOR_BLE_DEVICE":
      return KeyFormFactor.KEY_FORM_FACTOR_BLE_DEVICE;
    case 4:
    case "KEY_FORM_FACTOR_NFC_DEVICE":
      return KeyFormFactor.KEY_FORM_FACTOR_NFC_DEVICE;
    case 5:
    case "KEY_FORM_FACTOR_BLE_AND_NFC_DEVICE":
      return KeyFormFactor.KEY_FORM_FACTOR_BLE_AND_NFC_DEVICE;
    case 6:
    ...
    case 8:
    case "KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB_P60":
      return KeyFormFactor.KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB_P60;
    case 9:
    case "KEY_FORM_FACTOR_CLOUD_KEY":
      return KeyFormFactor.KEY_FORM_FACTOR_CLOUD_KEY;
    case 10:
    case "KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60":
      return KeyFormFactor.KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60;
    case 11:
    case "KEY_FORM_FACTOR_5_BUTTON_GEN2_CAR_KEYFOB_P60":
      return KeyFormFactor.KEY_FORM_FACTOR_5_BUTTON_GEN2_CAR_KEYFOB_P60;
    case 12:
    case "KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V2":
      return KeyFormFactor.KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V2;
    case 13:
    case "KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V3":
      return KeyFormFactor.KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V3;
    case 14:
    case "KEY_FORM_FACTOR_NFC_CARD_P71":
      return KeyFormFactor.KEY_FORM_FACTOR_NFC_CARD_P71;
    case 15:
    case "KEY_FORM_FACTOR_NFC_CARD_METAL_CARD":
      return KeyFormFactor.KEY_FORM_FACTOR_NFC_CARD_METAL_CARD;
    case 16:
    case "KEY_FORM_FACTOR_NFC_CARD_PLASTIC_CARD":
      return KeyFormFactor.KEY_FORM_FACTOR_NFC_CARD_PLASTIC_CARD;
    case 17:
    case "KEY_FORM_FACTOR_APPLE_WATCH":
      return KeyFormFactor.KEY_FORM_FACTOR_APPLE_WATCH;
    case 18:
    case "KEY_FORM_FACTOR_NFC_CARD_WD_PLASTIC_CARD":
      return KeyFormFactor.KEY_FORM_FACTOR_NFC_CARD_WD_PLASTIC_CARD;
    case 19:
    case "KEY_FORM_FACTOR_HARMONY_OS_NEXT_DEVICE":
      return KeyFormFactor.KEY_FORM_FACTOR_HARMONY_OS_NEXT_DEVICE;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function keyFormFactorToJSON(object: KeyFormFactor): string {
  switch (object) {
    ...
    case KeyFormFactor.KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB:
      return "KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB";
    case KeyFormFactor.KEY_FORM_FACTOR_BLE_DEVICE:
      return "KEY_FORM_FACTOR_BLE_DEVICE";
    case KeyFormFactor.KEY_FORM_FACTOR_NFC_DEVICE:
      return "KEY_FORM_FACTOR_NFC_DEVICE";
    case KeyFormFactor.KEY_FORM_FACTOR_BLE_AND_NFC_DEVICE:
      return "KEY_FORM_FACTOR_BLE_AND_NFC_DEVICE";
    ...
    case KeyFormFactor.KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB_P60:
      return "KEY_FORM_FACTOR_3_BUTTON_BLE_CAR_KEYFOB_P60";
    case KeyFormFactor.KEY_FORM_FACTOR_CLOUD_KEY:
      return "KEY_FORM_FACTOR_CLOUD_KEY";
    case KeyFormFactor.KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60:
      return "KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60";
    case KeyFormFactor.KEY_FORM_FACTOR_5_BUTTON_GEN2_CAR_KEYFOB_P60:
      return "KEY_FORM_FACTOR_5_BUTTON_GEN2_CAR_KEYFOB_P60";
    case KeyFormFactor.KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V2:
      return "KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V2";
    case KeyFormFactor.KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V3:
      return "KEY_FORM_FACTOR_3_BUTTON_GEN2_CAR_KEYFOB_P60_V3";
    case KeyFormFactor.KEY_FORM_FACTOR_NFC_CARD_P71:
      return "KEY_FORM_FACTOR_NFC_CARD_P71";
    case KeyFormFactor.KEY_FORM_FACTOR_NFC_CARD_METAL_CARD:
      return "KEY_FORM_FACTOR_NFC_CARD_METAL_CARD";
    case KeyFormFactor.KEY_FORM_FACTOR_NFC_CARD_PLASTIC_CARD:
      return "KEY_FORM_FACTOR_NFC_CARD_PLASTIC_CARD";
    case KeyFormFactor.KEY_FORM_FACTOR_APPLE_WATCH:
      return "KEY_FORM_FACTOR_APPLE_WATCH";
    case KeyFormFactor.KEY_FORM_FACTOR_NFC_CARD_WD_PLASTIC_CARD:
      return "KEY_FORM_FACTOR_NFC_CARD_WD_PLASTIC_CARD";
    case KeyFormFactor.KEY_FORM_FACTOR_HARMONY_OS_NEXT_DEVICE:
      return "KEY_FORM_FACTOR_HARMONY_OS_NEXT_DEVICE";
...
export enum InformationRequestType {
  ...
  /** INFORMATION_REQUEST_TYPE_GET_TOKEN - TESLEMETRY-EXT (app-4.58.6) */
  INFORMATION_REQUEST_TYPE_GET_TOKEN = 1,
  /** INFORMATION_REQUEST_TYPE_GET_COUNTER - TESLEMETRY-EXT (app-4.58.6) */
  INFORMATION_REQUEST_TYPE_GET_COUNTER = 2,
  /** INFORMATION_REQUEST_TYPE_GET_EPHEMERAL_PUBLIC_KEY - TESLEMETRY-EXT (app-4.58.6) */
  INFORMATION_REQUEST_TYPE_GET_EPHEMERAL_PUBLIC_KEY = 3,
  /** INFORMATION_REQUEST_TYPE_GET_SESSION_DATA - TESLEMETRY-EXT (app-4.58.6) */
  ...
  /** INFORMATION_REQUEST_TYPE_GET_PERSONALIZATION_INFO - TESLEMETRY-EXT (app-4.58.6) */
  INFORMATION_REQUEST_TYPE_GET_PERSONALIZATION_INFO = 7,
  /** INFORMATION_REQUEST_TYPE_GET_KEYSTATUS_INFO - TESLEMETRY-EXT (app-4.58.6) */
  INFORMATION_REQUEST_TYPE_GET_KEYSTATUS_INFO = 8,
  /** INFORMATION_REQUEST_TYPE_GET_ACTIVE_KEY - TESLEMETRY-EXT (app-4.58.6) */
  INFORMATION_REQUEST_TYPE_GET_ACTIVE_KEY = 9,
  /** INFORMATION_REQUEST_TYPE_GET_CAPABILITIES - TESLEMETRY-EXT (app-4.58.6) */
...
export function informationRequestTypeFromJSON(object: any): InformationRequestType {
  switch (object) {
    ...
    case 1:
    case "INFORMATION_REQUEST_TYPE_GET_TOKEN":
      return InformationRequestType.INFORMATION_REQUEST_TYPE_GET_TOKEN;
    case 2:
    case "INFORMATION_REQUEST_TYPE_GET_COUNTER":
      return InformationRequestType.INFORMATION_REQUEST_TYPE_GET_COUNTER;
    case 3:
    case "INFORMATION_REQUEST_TYPE_GET_EPHEMERAL_PUBLIC_KEY":
      return InformationRequestType.INFORMATION_REQUEST_TYPE_GET_EPHEMERAL_PUBLIC_KEY;
    case 4:
    case "INFORMATION_REQUEST_TYPE_GET_SESSION_DATA":
      return InformationRequestType.INFORMATION_REQUEST_TYPE_GET_SESSION_DATA;
    case 5:
    ...
    case 7:
    case "INFORMATION_REQUEST_TYPE_GET_PERSONALIZATION_INFO":
      return InformationRequestType.INFORMATION_REQUEST_TYPE_GET_PERSONALIZATION_INFO;
    case 8:
    case "INFORMATION_REQUEST_TYPE_GET_KEYSTATUS_INFO":
      return InformationRequestType.INFORMATION_REQUEST_TYPE_GET_KEYSTATUS_INFO;
    case 9:
    case "INFORMATION_REQUEST_TYPE_GET_ACTIVE_KEY":
      return InformationRequestType.INFORMATION_REQUEST_TYPE_GET_ACTIVE_KEY;
    case 16:
    case "INFORMATION_REQUEST_TYPE_GET_CAPABILITIES":
      return InformationRequestType.INFORMATION_REQUEST_TYPE_GET_CAPABILITIES;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function informationRequestTypeToJSON(object: InformationRequestType): string {
  switch (object) {
    ...
    case InformationRequestType.INFORMATION_REQUEST_TYPE_GET_TOKEN:
      return "INFORMATION_REQUEST_TYPE_GET_TOKEN";
    case InformationRequestType.INFORMATION_REQUEST_TYPE_GET_COUNTER:
      return "INFORMATION_REQUEST_TYPE_GET_COUNTER";
    case InformationRequestType.INFORMATION_REQUEST_TYPE_GET_EPHEMERAL_PUBLIC_KEY:
      return "INFORMATION_REQUEST_TYPE_GET_EPHEMERAL_PUBLIC_KEY";
    case InformationRequestType.INFORMATION_REQUEST_TYPE_GET_SESSION_DATA:
      return "INFORMATION_REQUEST_TYPE_GET_SESSION_DATA";
    ...
    case InformationRequestType.INFORMATION_REQUEST_TYPE_GET_PERSONALIZATION_INFO:
      return "INFORMATION_REQUEST_TYPE_GET_PERSONALIZATION_INFO";
    case InformationRequestType.INFORMATION_REQUEST_TYPE_GET_KEYSTATUS_INFO:
      return "INFORMATION_REQUEST_TYPE_GET_KEYSTATUS_INFO";
    case InformationRequestType.INFORMATION_REQUEST_TYPE_GET_ACTIVE_KEY:
      return "INFORMATION_REQUEST_TYPE_GET_ACTIVE_KEY";
    case InformationRequestType.INFORMATION_REQUEST_TYPE_GET_CAPABILITIES:
      return "INFORMATION_REQUEST_TYPE_GET_CAPABILITIES";
...
export enum RKEActionE {
  RKE_ACTION_UNLOCK = 0,
  RKE_ACTION_LOCK = 1,
  /** RKE_ACTION_OPEN_TRUNK - TESLEMETRY-EXT (app-4.58.6) */
  RKE_ACTION_OPEN_TRUNK = 2,
  /** RKE_ACTION_OPEN_FRUNK - TESLEMETRY-EXT (app-4.58.6) */
  RKE_ACTION_OPEN_FRUNK = 3,
  /** RKE_ACTION_OPEN_CHARGE_PORT - TESLEMETRY-EXT (app-4.58.6) */
  RKE_ACTION_OPEN_CHARGE_PORT = 4,
  /** RKE_ACTION_CLOSE_CHARGE_PORT - TESLEMETRY-EXT (app-4.58.6) */
  RKE_ACTION_CLOSE_CHARGE_PORT = 5,
  /** RKE_ACTION_CANCEL_EXTERNAL_AUTHENTICATE - TESLEMETRY-EXT (app-4.58.6) */
  RKE_ACTION_CANCEL_EXTERNAL_AUTHENTICATE = 6,
  /** RKE_ACTION_UNKNOWN - TESLEMETRY-EXT (app-4.58.6) */
  RKE_ACTION_UNKNOWN = 19,
  RKE_ACTION_REMOTE_DRIVE = 20,
  RKE_ACTION_AUTO_SECURE_VEHICLE = 29,
  RKE_ACTION_WAKE_VEHICLE = 30,
  /** RKE_ACTION_UNLOCK_AND_REMOTE_DRIVE - TESLEMETRY-EXT (app-4.58.6) */
...
export function rKEActionEFromJSON(object: any): RKEActionE {
  switch (object) {
    ...
    case 2:
    case "RKE_ACTION_OPEN_TRUNK":
      return RKEActionE.RKE_ACTION_OPEN_TRUNK;
    case 3:
    case "RKE_ACTION_OPEN_FRUNK":
      return RKEActionE.RKE_ACTION_OPEN_FRUNK;
    case 4:
    case "RKE_ACTION_OPEN_CHARGE_PORT":
      return RKEActionE.RKE_ACTION_OPEN_CHARGE_PORT;
    case 5:
    case "RKE_ACTION_CLOSE_CHARGE_PORT":
      return RKEActionE.RKE_ACTION_CLOSE_CHARGE_PORT;
    case 6:
    case "RKE_ACTION_CANCEL_EXTERNAL_AUTHENTICATE":
      return RKEActionE.RKE_ACTION_CANCEL_EXTERNAL_AUTHENTICATE;
    case 19:
    case "RKE_ACTION_UNKNOWN":
      return RKEActionE.RKE_ACTION_UNKNOWN;
    case 20:
    ...
    case 31:
    case "RKE_ACTION_UNLOCK_AND_REMOTE_DRIVE":
      return RKEActionE.RKE_ACTION_UNLOCK_AND_REMOTE_DRIVE;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function rKEActionEToJSON(object: RKEActionE): string {
  switch (object) {
    ...
    case RKEActionE.RKE_ACTION_OPEN_TRUNK:
      return "RKE_ACTION_OPEN_TRUNK";
    case RKEActionE.RKE_ACTION_OPEN_FRUNK:
      return "RKE_ACTION_OPEN_FRUNK";
    case RKEActionE.RKE_ACTION_OPEN_CHARGE_PORT:
      return "RKE_ACTION_OPEN_CHARGE_PORT";
    case RKEActionE.RKE_ACTION_CLOSE_CHARGE_PORT:
      return "RKE_ACTION_CLOSE_CHARGE_PORT";
    case RKEActionE.RKE_ACTION_CANCEL_EXTERNAL_AUTHENTICATE:
      return "RKE_ACTION_CANCEL_EXTERNAL_AUTHENTICATE";
    case RKEActionE.RKE_ACTION_UNKNOWN:
      return "RKE_ACTION_UNKNOWN";
    ...
    case RKEActionE.RKE_ACTION_UNLOCK_AND_REMOTE_DRIVE:
      return "RKE_ACTION_UNLOCK_AND_REMOTE_DRIVE";
...
export enum ClosureMoveTypeE {
  ...
  /** CLOSURE_MOVE_TYPE_OVERRIDE_OPEN - TESLEMETRY-EXT (app-4.58.6) */
  CLOSURE_MOVE_TYPE_OVERRIDE_OPEN = 5,
  /** CLOSURE_MOVE_TYPE_OVERRIDE_CLOSE - TESLEMETRY-EXT (app-4.58.6) */
  CLOSURE_MOVE_TYPE_OVERRIDE_CLOSE = 6,
  UNRECOGNIZED = -1,
}
...
export function closureMoveTypeEFromJSON(object: any): ClosureMoveTypeE {
  switch (object) {
    ...
    case 5:
    case "CLOSURE_MOVE_TYPE_OVERRIDE_OPEN":
      return ClosureMoveTypeE.CLOSURE_MOVE_TYPE_OVERRIDE_OPEN;
    case 6:
    case "CLOSURE_MOVE_TYPE_OVERRIDE_CLOSE":
      return ClosureMoveTypeE.CLOSURE_MOVE_TYPE_OVERRIDE_CLOSE;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function closureMoveTypeEToJSON(object: ClosureMoveTypeE): string {
  switch (object) {
    ...
    case ClosureMoveTypeE.CLOSURE_MOVE_TYPE_OVERRIDE_OPEN:
      return "CLOSURE_MOVE_TYPE_OVERRIDE_OPEN";
    case ClosureMoveTypeE.CLOSURE_MOVE_TYPE_OVERRIDE_CLOSE:
      return "CLOSURE_MOVE_TYPE_OVERRIDE_CLOSE";
...
export enum WhitelistOperationInformationE {
  ...
  /** WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_RIDER_KEY - TESLEMETRY-EXT (app-4.58.6) */
  WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_RIDER_KEY = 29,
  /** WHITELISTOPERATION_INFORMATION_ATTEMPTING_TO_ADD_RIDER_KEY_OUTSIDE_FLEET_MODE - TESLEMETRY-EXT (app-4.58.6) */
  WHITELISTOPERATION_INFORMATION_ATTEMPTING_TO_ADD_RIDER_KEY_OUTSIDE_FLEET_MODE = 30,
  /** WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_PREDELIVERY_KEY - TESLEMETRY-EXT (app-4.58.6) */
  WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_PREDELIVERY_KEY = 31,
  /** WHITELISTOPERATION_INFORMATION_SERVICE_KEY_ATTEMPTING_TO_ADD_PREDELIVERY_KEY_WHEN_ALREADY_DELIVERED - TESLEMETRY-EXT (app-4.58.6) */
...
export function whitelistOperationInformationEFromJSON(object: any): WhitelistOperationInformationE {
  switch (object) {
    ...
    case 23:
    case "WHITELISTOPERATION_INFORMATION_COULD_NOT_START_LOCAL_ENTITY_AUTH":
      return WhitelistOperationInformationE.WHITELISTOPERATION_INFORMATION_COULD_NOT_START_LOCAL_ENTITY_AUTH;
    case 24:
    case "WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_UI_DENIED":
      return WhitelistOperationInformationE.WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_UI_DENIED;
    case 25:
    case "WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_TIMED_OUT_WAITING_FOR_TAP":
      return WhitelistOperationInformationE
        .WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_TIMED_OUT_WAITING_FOR_TAP;
    case 26:
    case "WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_TIMED_OUT_WAITING_FOR_UI_ACK":
      return WhitelistOperationInformationE
        .WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_TIMED_OUT_WAITING_FOR_UI_ACK;
    case 27:
    case "WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_VALET_MODE":
      return WhitelistOperationInformationE.WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_VALET_MODE;
    case 28:
    case "WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_CANCELLED":
      return WhitelistOperationInformationE.WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_CANCELLED;
    case 29:
    case "WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_RIDER_KEY":
      return WhitelistOperationInformationE.WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_RIDER_KEY;
    case 30:
    case "WHITELISTOPERATION_INFORMATION_ATTEMPTING_TO_ADD_RIDER_KEY_OUTSIDE_FLEET_MODE":
      return WhitelistOperationInformationE
        .WHITELISTOPERATION_INFORMATION_ATTEMPTING_TO_ADD_RIDER_KEY_OUTSIDE_FLEET_MODE;
    case 31:
    case "WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_PREDELIVERY_KEY":
      return WhitelistOperationInformationE
        .WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_PREDELIVERY_KEY;
    case 32:
    case "WHITELISTOPERATION_INFORMATION_SERVICE_KEY_ATTEMPTING_TO_ADD_PREDELIVERY_KEY_WHEN_ALREADY_DELIVERED":
      return WhitelistOperationInformationE
        .WHITELISTOPERATION_INFORMATION_SERVICE_KEY_ATTEMPTING_TO_ADD_PREDELIVERY_KEY_WHEN_ALREADY_DELIVERED;
    case -1:
    case "UNRECOGNIZED":
    default:
...
export function whitelistOperationInformationEToJSON(object: WhitelistOperationInformationE): string {
  switch (object) {
    ...
    case WhitelistOperationInformationE.WHITELISTOPERATION_INFORMATION_COULD_NOT_START_LOCAL_ENTITY_AUTH:
      return "WHITELISTOPERATION_INFORMATION_COULD_NOT_START_LOCAL_ENTITY_AUTH";
    case WhitelistOperationInformationE.WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_UI_DENIED:
      return "WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_UI_DENIED";
    case WhitelistOperationInformationE
      .WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_TIMED_OUT_WAITING_FOR_TAP:
      return "WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_TIMED_OUT_WAITING_FOR_TAP";
    case WhitelistOperationInformationE
      .WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_TIMED_OUT_WAITING_FOR_UI_ACK:
      return "WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_TIMED_OUT_WAITING_FOR_UI_ACK";
    case WhitelistOperationInformationE.WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_VALET_MODE:
      return "WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_VALET_MODE";
    case WhitelistOperationInformationE.WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_CANCELLED:
      return "WHITELISTOPERATION_INFORMATION_LOCAL_ENTITY_AUTH_FAILED_CANCELLED";
    case WhitelistOperationInformationE.WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_RIDER_KEY:
      return "WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_RIDER_KEY";
    case WhitelistOperationInformationE.WHITELISTOPERATION_INFORMATION_ATTEMPTING_TO_ADD_RIDER_KEY_OUTSIDE_FLEET_MODE:
      return "WHITELISTOPERATION_INFORMATION_ATTEMPTING_TO_ADD_RIDER_KEY_OUTSIDE_FLEET_MODE";
    case WhitelistOperationInformationE
      .WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_PREDELIVERY_KEY:
      return "WHITELISTOPERATION_INFORMATION_NON_SERVICE_KEY_ATTEMPTING_TO_ADD_PREDELIVERY_KEY";
    case WhitelistOperationInformationE
      .WHITELISTOPERATION_INFORMATION_SERVICE_KEY_ATTEMPTING_TO_ADD_PREDELIVERY_KEY_WHEN_ALREADY_DELIVERED:
      return "WHITELISTOPERATION_INFORMATION_SERVICE_KEY_ATTEMPTING_TO_ADD_PREDELIVERY_KEY_WHEN_ALREADY_DELIVERED";
...
export function uIDesireEFromJSON(object: any): UIDesireE {
  switch (object) {
    case 0:
    case "UI_DESIRE_NONE":
      return UIDesireE.UI_DESIRE_NONE;
    case 1:
    case "UI_DESIRE_HAS_DATA":
      return UIDesireE.UI_DESIRE_HAS_DATA;
    case -1:
    case "UNRECOGNIZED":
    default:
      return UIDesireE.UNRECOGNIZED;
  }
}

export function uIDesireEToJSON(object: UIDesireE): string {
  switch (object) {
    case UIDesireE.UI_DESIRE_NONE:
      return "UI_DESIRE_NONE";
    case UIDesireE.UI_DESIRE_HAS_DATA:
      return "UI_DESIRE_HAS_DATA";
    case UIDesireE.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export function gearEFromJSON(object: any): GearE {
  switch (object) {
    case 0:
    case "GEAR_UNKNOWN":
      return GearE.GEAR_UNKNOWN;
    case 1:
    case "GEAR_PARK":
      return GearE.GEAR_PARK;
    case 2:
    case "GEAR_DRIVE":
      return GearE.GEAR_DRIVE;
    case 3:
    case "GEAR_REVERSE":
      return GearE.GEAR_REVERSE;
    case 4:
    case "GEAR_NEUTRAL":
      return GearE.GEAR_NEUTRAL;
    case -1:
    case "UNRECOGNIZED":
    default:
      return GearE.UNRECOGNIZED;
  }
}

export function gearEToJSON(object: GearE): string {
  switch (object) {
    case GearE.GEAR_UNKNOWN:
      return "GEAR_UNKNOWN";
    case GearE.GEAR_PARK:
      return "GEAR_PARK";
    case GearE.GEAR_DRIVE:
      return "GEAR_DRIVE";
    case GearE.GEAR_REVERSE:
      return "GEAR_REVERSE";
    case GearE.GEAR_NEUTRAL:
      return "GEAR_NEUTRAL";
    case GearE.UNRECOGNIZED:
    default:
      return "UNRECOGNIZED";
  }
}
...
export const SignedMessage: MessageFns<SignedMessage> = {
  ...
  toJSON(message: SignedMessage): unknown {
    ...
    if (message.signatureType !== undefined) {
...
export const KeyIdentifier: MessageFns<KeyIdentifier> = {
  ...
  toJSON(message: KeyIdentifier): unknown {
    const obj: any = {};
    if (message.publicKeySHA1 !== undefined) {
...
export const KeyMetadata: MessageFns<KeyMetadata> = {
  ...
  toJSON(message: KeyMetadata): unknown {
    const obj: any = {};
    if (message.keyFormFactor !== undefined) {
...
export const PublicKey: MessageFns<PublicKey> = {
  ...
  toJSON(message: PublicKey): unknown {
    const obj: any = {};
    if (message.PublicKeyRaw !== undefined) {
...
export const WhitelistInfo: MessageFns<WhitelistInfo> = {
  ...
  toJSON(message: WhitelistInfo): unknown {
    const obj: any = {};
    if (message.numberOfEntries !== undefined) {
...
export const InformationRequest: MessageFns<InformationRequest> = {
  ...
  toJSON(message: InformationRequest): unknown {
    const obj: any = {};
    if (message.informationRequestType !== undefined) {
...
export const PermissionChange: MessageFns<PermissionChange> = {
  ...
  toJSON(message: PermissionChange): unknown {
    ...
    if (message.secondsToBeActive !== undefined) {
...
export const ReplaceKey: MessageFns<ReplaceKey> = {
  ...
  toJSON(message: ReplaceKey): unknown {
    ...
    if (message.impermanent !== undefined) {
...
export const WhitelistOperationStatus: MessageFns<WhitelistOperationStatus> = {
  ...
  toJSON(message: WhitelistOperationStatus): unknown {
    const obj: any = {};
    if (message.whitelistOperationInformation !== undefined) {
...
export const SignedMessageStatus: MessageFns<SignedMessageStatus> = {
  ...
  toJSON(message: SignedMessageStatus): unknown {
    ...
    if (message.signedMessageInformation !== undefined) {
...
export const VehicleStatus: MessageFns<VehicleStatus> = {
  encode(message: VehicleStatus, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.uiDesire !== 0) {
      writer.uint32(48).int32(message.uiDesire);
    }
    if (message.gear !== 0) {
      writer.uint32(56).int32(message.gear);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 6: {
          ...
          message.uiDesire = reader.int32() as any;
          continue;
        }
        case 7: {
          if (tag !== 56) {
  ...
  fromJSON(object: any): VehicleStatus {
    return {
      ...
      detailedClosureStatus: isSet(object.detailedClosureStatus)
        ...
        : undefined,
      uiDesire: isSet(object.uiDesire) ? uIDesireEFromJSON(object.uiDesire) : 0,
      gear: isSet(object.gear) ? gearEFromJSON(object.gear) : 0,
    };
  },
  ...
  toJSON(message: VehicleStatus): unknown {
    ...
    if (message.uiDesire !== undefined) {
      obj.uiDesire = uIDesireEToJSON(message.uiDesire);
    }
    if (message.gear !== undefined) {
      obj.gear = gearEToJSON(message.gear);
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<VehicleStatus>, I>>(object: I): VehicleStatus {
    ...
    message.detailedClosureStatus =
      (object.detailedClosureStatus !== undefined && object.detailedClosureStatus !== null)
        ...
        : undefined;
    message.uiDesire = object.uiDesire ?? 0;
